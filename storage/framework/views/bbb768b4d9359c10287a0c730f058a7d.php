...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.rent-vehicle-bookings.store')); ?>" method="POST" id="rentBookingForm">
                <?php echo csrf_field(); ?>
                <input type="hidden" id="invoice_no" value="<?php echo e($nextInvoice ?? 'INV0001'); ?>">
                        ...
                        <select name="vehicle_id" id="vehicle_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <option value="<?php echo e($vehicle->id); ?>" data-images='<?php echo json_encode($images, 15, 512) ?>'>
                                    <?php echo e($vehicle->vehicle_name ?? $vehicle->name); ?> -
                                    <?php echo e($vehicle->vehicle_number ?? $vehicle->model); ?>
                ...
                <div class="text-end gap-2 d-flex justify-content-end">
                       <a href="<?php echo e(route('admin.rent-vehicle-bookings.index')); ?>" class="btn btn-light" style="width:130px;">Back</a>
...
`;
        ...
        function generatePdf() {
            ...
            fetch("<?php echo e(route('admin.rent-vehicle-bookings.generatePdf')); ?>", {
                    method: "POST",
                    headers: {
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Create Rent Vehicle Booking'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Vacay Guider\vacay-admin\resources\views/bookings/rent/create.blade.php ENDPATH**/ ?>