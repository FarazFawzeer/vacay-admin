    ...
    <div class="card-t">
        ...
        <div class="card mb-4" id="createVehicleCard" style="display: none;">
            <div class="card-body">
                ...
                <form id="createVehicleForm" action="<?php echo e(route('admin.vehicles.store')); ?>" method="POST"
                    ...
                    <table class="table table-hover table-centered">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr id="vehicle-<?php echo e($vehicle->id); ?>">
                                    <td>
                                        <?php if($vehicle->vehicle_image): ?>
                                            <img src="<?php echo e(asset('storage/' . $vehicle->vehicle_image)); ?>"
                                                class="vehicle-img" alt="<?php echo e($vehicle->name); ?>">
                                        <?php else: ?>
                                    ...
                                    <td><?php echo e(ucfirst($vehicle->transmission ?? '-')); ?></td>
                                    <td><?php echo e($vehicle->seats ?? '-'); ?></td>
                                    <td><?php echo e($vehicle->milage ?? '-'); ?></td>
                                    <td><?php echo e($vehicle->air_conditioned ? 'Yes' : 'No'); ?></td>
                                    <td><?php echo e($vehicle->helmet ? 'Yes' : 'No'); ?></td>
                                    <td><?php echo e($vehicle->first_aid_kit ? 'Yes' : 'No'); ?></td>
                                    <td><?php echo e(number_format($vehicle->price, 2)); ?></td>
                                    <td><?php echo e(ucfirst($vehicle->type ?? '-')); ?></td>
                                    <td>
                                    ...
                                    <td><?php echo e($vehicle->updated_at ? $vehicle->updated_at->format('d M Y, h:i A') : '-'); ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="icon-btn text-primary editVehicleBtn"
                                            data-id="<?php echo e($vehicle->id); ?>" data-name="<?php echo e($vehicle->name); ?>"
                                            data-make="<?php echo e($vehicle->make); ?>" data-model="<?php echo e($vehicle->model); ?>"
                                            data-seats="<?php echo e($vehicle->seats); ?>" data-milage="<?php echo e($vehicle->milage); ?>"
                                            data-air_conditioned="<?php echo e($vehicle->air_conditioned); ?>"
                                            data-helmet="<?php echo e($vehicle->helmet); ?>"
                                            data-first_aid_kit="<?php echo e($vehicle->first_aid_kit); ?>"
                                            data-condition="<?php echo e($vehicle->condition); ?>"
                                            data-transmission="<?php echo e($vehicle->transmission); ?>"
                                            data-price="<?php echo e($vehicle->price); ?>" data-type="<?php echo e($vehicle->type); ?>"
                                            data-status="<?php echo e($vehicle->status); ?>"
                                            data-subimages='<?php echo json_encode($vehicle->sub_image, 15, 512) ?>' data-bs-toggle="modal"
                                        ...
                                        <button type="button"
                                            class="icon-btn toggle-status-btn <?php echo e($vehicle->status ? 'text-success' : 'text-warning'); ?>"
                                            data-id="<?php echo e($vehicle->id); ?>" data-status="<?php echo e($vehicle->status); ?>"
                                            title="<?php echo e($vehicle->status ? 'Set as Inactive' : 'Set as Active'); ?>">
                                        ...
                                        <button type="button" class="icon-btn text-danger delete-vehicle"
                                            data-id="<?php echo e($vehicle->id); ?>" title="Delete Vehicle">
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Vehicles'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Vacay Guider\vacay-admin\resources\views/details/vehicle.blade.php ENDPATH**/ ?>