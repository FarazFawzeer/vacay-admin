...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-3">
        ...
        <select id="filterCategory" class="form-select">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($category); ?>" <?php echo e(($currentFilters['category'] ?? '') === $category ? 'selected' : ''); ?>>
    ...
    <div class="col-md-3">
        ...
        <select id="filterStatus" class="form-select">
            <option value="">All</option>
            <option value="active" <?php echo e(($currentFilters['status'] ?? '') === 'active' ? 'selected' : ''); ?>>Published</option>
            <option value="inactive" <?php echo e(($currentFilters['status'] ?? '') === 'inactive' ? 'selected' : ''); ?>>Unpublished</option>
        </select>
    </div>
            </div>
