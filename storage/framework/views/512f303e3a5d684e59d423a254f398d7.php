...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="quotationForm" action="<?php echo e(route('admin.tour-bookings.update', $booking->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <select name="customer_id" id="customer_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($customer->id); ?>" data-email="<?php echo e($customer->email); ?>"
                                    ...
                                    <?php echo e($booking->customer_id == $customer->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="package_id" id="package_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($package->id); ?>" data-price="<?php echo e($package->price); ?>"
                                    data-tour-ref="<?php echo e($package->tour_ref_no); ?>"
                                    <?php echo e($booking->package_id == $package->id ? 'selected' : ''); ?>>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="date" id="travel_start_date" class="form-control" name="travel_start_date"
                            value="<?php echo e(\Carbon\Carbon::parse($booking->travel_date)->format('Y-m-d')); ?>">
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="date" id="travel_end_date" class="form-control" name="travel_end_date"
                            value="<?php echo e(\Carbon\Carbon::parse($booking->travel_end_date)->format('Y-m-d')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label for="adults" class="form-label">Adults</label>
                        <input type="number" name="adults" id="adults" class="form-control"
                            value="<?php echo e($booking->adults); ?>" min="0" required>
                    </div>
                    <div class="col-md-2">
                        <label for="children" class="form-label">Children</label>
                        <input type="number" name="children" id="children" class="form-control"
                            value="<?php echo e($booking->children); ?>" min="0">
                    </div>
                    <div class="col-md-2">
                        <label for="infants" class="form-label">Infants</label>
                        <input type="number" name="infants" id="infants" class="form-control"
                            value="<?php echo e($booking->infants); ?>" min="0">
                    </div>
                    <div class="col-md-2">
                        <label for="currency" class="form-label">Currency</label>
                        <select name="currency" id="currency" class="form-select">
                            <option value="USD" <?php echo e($booking->currency == 'USD' ? 'selected' : ''); ?>>USD</option>
                            <option value="LKR" <?php echo e($booking->currency == 'LKR' ? 'selected' : ''); ?>>LKR</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <select name="status" id="status" class="form-select" required>
                            <option value="quotation" <?php echo e($booking->status == 'quotation' ? 'selected' : ''); ?>>Quotation
                            </option>
                            <option value="invoiced" <?php echo e($booking->status == 'invoiced' ? 'selected' : ''); ?>>Invoice
                            </option>
                            <option value="confirmed" <?php echo e($booking->status == 'confirmed' ? 'selected' : ''); ?>>Confirmed
                            </option>
                            <option value="completed" <?php echo e($booking->status == 'completed' ? 'selected' : ''); ?>>Completed
                            </option>
                            <option value="cancelled" <?php echo e($booking->status == 'cancelled' ? 'selected' : ''); ?>>Cancelled
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="payment_status" id="payment_status" class="form-select" required>
                            ...
                            <option value="partial" <?php echo e($booking->payment_status == 'partial' ? 'selected' : ''); ?>>Partial
                            </option>
                            <option value="paid" <?php echo e($booking->payment_status == 'paid' ? 'selected' : ''); ?>>Paid
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" name="package_price" id="package_price" class="form-control"
                            step="0.01" value="<?php echo e($booking->package_price); ?>" required>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="special_requirements" id="special_requirements" class="form-control" rows="3"><?php echo e($booking->special_requirements); ?></textarea>
                </div>

                
                <div class="d-flex justify-content-end gap-2">
                    <button type="button" class="btn btn-warning" style="width:120px;"
                        onclick="window.location='<?php echo e(route('admin.tour-bookings.index')); ?>'">
                        Back
                    </button>
    ...
    <script>
        ...
        function previewQuotation() {
            ...
            const invoiceNumber = "<?php echo e($booking->invoice_number); ?>"; // or generate dynamically if needed
...
<div style="max-width:900px; margin:0 auto; font-family:'Segoe UI', sans-serif; background:#fff; box-shadow:0 0 20px rgba(0,0,0,0.1);">
    <div style="padding:40px; border-bottom:2px solid #e0e0e0;">
        <div style="text-align:center; margin-bottom:30px;">
            <img src="<?php echo e(asset('images/vacayguider.png')); ?>" alt="Company Logo" style=" height:120px; object-fit:contain;">
        </div>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Edit Tour Quotation / Invoice'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Vacay Guider\vacay-admin\resources\views/bookings/edit_tour.blade.php ENDPATH**/ ?>