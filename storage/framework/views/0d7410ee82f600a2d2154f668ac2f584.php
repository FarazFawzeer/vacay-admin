                    ...
                    <div class="col-md-3 mb-3">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="special_feature" value="1"
                                <?php echo e($package->hilight_show_hide ? 'checked' : ''); ?>>
...
<div class="card mt-4">
    ...
    <div class="card-body" id="inclusionWrapper">
        <?php $__currentLoopData = $inclusions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mb-4 border-bottom pb-3 inclusion-block" data-index="<?php echo e($index); ?>">
                <h6 class="fw-bold text-capitalize text-primary"><?php echo e(ucfirst($item->type)); ?></h6>

                
                <div class="mb-2">
                    <label><strong>Heading:</strong></label>
                    <input type="text" name="package_inclusions[<?php echo e($index); ?>][heading]"
                        class="form-control"
                        value="<?php echo e(old('package_inclusions.' . $index . '.heading', $item->heading)); ?>">
                </div>

                
                <label><strong>Points:</strong></label>
                <div class="points-wrapper mb-2">
                    <?php $__currentLoopData = $item->points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pIndex => $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex mb-2 point-row">
                            <input type="text" name="package_inclusions[<?php echo e($index); ?>][points][<?php echo e($pIndex); ?>]"
                                value="<?php echo e($point); ?>" class="form-control me-2">
                ...
                <div class="mt-3">
                    ...
                    <textarea name="package_inclusions[<?php echo e($index); ?>][note]" class="form-control" rows="2"><?php echo e($item->note); ?></textarea>
                </div>

                <input type="hidden" name="package_inclusions[<?php echo e($index); ?>][type]" value="<?php echo e($item->type); ?>">
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
