...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['title' => 'Tour Packages', 'subtitle' => 'View Details'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center" style="position: relative; z-index: 10;">
            <h5 class="card-title mb-0"><?php echo e($package->heading); ?></h5>

            <div class="d-flex gap-2">
                <a href="<?php echo e(route('admin.packages.index')); ?>" class="btn btn-secondary btn-sm">
                    Back to List
                </a>
                <a href="<?php echo e(route('admin.package.pdf', $package->id)); ?>" class="btn btn-primary btn-sm" target="_blank">
                    Generate PDF
                </a>
            </div>
        </div>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="package-header">
                        <div class="header-content">
                            <!-- Country Badge -->
                            <div class="sri-lanka-badge"><?php echo e($package->country_name ?? 'Sri Lanka'); ?></div>

                            <!-- Main Heading - Centered -->
                            <h1 class="package-title" style="color: #313b5e;"><?php echo e($package->heading); ?></h1>
                            ...
                            <div class="route-display">
                                ...
                                <div class="route-path">
                                    <span class="route-point">
                                        <img src="<?php echo e(asset('images/plane-departure.svg')); ?>" alt="Plane Departure"
                                            width="16" height="16">
                                        Airport
                                    </span>
                    ...
                    <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($package->place); ?>" class="hero-image" loading="lazy">
                    ...
                    <div class="tour-summary-card" id="summary-section">
                        <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
                            ...
                            <div class="duration-badge">
                                ...
                                <span><?php echo e($package->days ?? 0); ?> Days, <?php echo e($package->nights ?? 0); ?> Nights</span>
                            </div>
                        </div>
                    ...
                    <?php $__currentLoopData = $package->detailItineraries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itinerary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="itinerary-card page-break">
                            ...
                            <?php $programs = explode('|', $itinerary->program); ?>
                                    ...
                                    <div class="highlights-grid">
                                        <?php $__currentLoopData = $itinerary->highlights->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $highlight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="highlight-item">
                                                <img src="<?php echo e($imageUrls[0] ?? $defaultImage); ?>"
                                                    alt="<?php echo e($highlight->highlight_places ?? 'Highlight'); ?>" loading="lazy">
                    ...
                    <?php if(!empty($package->map_image)): ?>
                        ...
                        <div class="map-section">
                            <h3>Tour Map</h3>
                            <img src="<?php echo e($mapImage); ?>" alt="Tour Route Map" class="map-image" loading="lazy">
                        </div>
                    <?php endif; ?>
                    ...
                    <!-- Inclusions -->
                    <?php if($packageInclusions->isNotEmpty()): ?>
                        <?php $__currentLoopData = $packageInclusions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inclusion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="info-list-section page-break">
                                <h3><?php echo e(ucfirst($inclusion->heading)); ?></h3>
                                <ul class="info-list">
                                    <?php $__currentLoopData = $inclusion->points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><?php echo e($point); ?></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>

                                <?php if(!empty($inclusion->note)): ?>
                                    <p style="margin-bottom: 10px;">
                                        <strong style="color: #000;">Note :</strong> <?php echo $inclusion->note; ?>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'View Tour Package'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Vacay Guider\vacay-admin\resources\views/tour/show.blade.php ENDPATH**/ ?>