...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?php echo e(route('admin.rent-vehicle-bookings.index')); ?>" class="btn btn-light me-2" style="width: 130px;">Back</a>
            ...
            <div id="invoiceContent">
                ...
                <div style="max-width:800px; margin:0 auto; font-family:Arial, sans-serif; background:#fff; padding:40px; border:1px solid #ddd;">
                    ...
                    <div style="text-align:center; margin-bottom:30px;">
                        ...
                        <span style="background:<?php echo e($badgeColor); ?>; color:white; padding:5px 15px; border-radius:3px; font-size:12px; font-weight:bold;">
                    ...
                    <table style="width:100%; margin-bottom:30px; border-collapse: collapse;border: none;">
                        <tr>
                            <td style="vertical-align: top; width:50%; padding-right:15px;">
                                ...
                                <p style="margin:5px 0; color:#666; font-size:14px;"><strong>Name:</strong> <?php echo e($booking->customer->name); ?></p>
                                <p style="margin:5px 0; color:#666; font-size:14px;"><strong>Email:</strong> <?php echo e($booking->customer->email ?? 'N/A'); ?></p>
                                <p style="margin:5px 0; color:#666; font-size:14px;"><strong>Phone:</strong> <?php echo e($booking->customer->contact ?? 'N/A'); ?></p>
                            </td>
                            <td style="vertical-align: top; width:50%; padding-left:15px; text-align:right;">
                                <p style="margin:5px 0; color:#666; font-size:14px;"><strong>Invoice No:</strong> <?php echo e($booking->inv_no); ?></p>
                                <p style="margin:5px 0; color:#666; font-size:14px;"><strong>Invoice Date:</strong> <?php echo e($booking->created_at->format('F d, Y')); ?></p>
                                <p style="margin:5px 0; color:#666; font-size:14px;"><strong>Payment Status:</strong>
                                    <span style="color:<?php echo e($badgeColor); ?>; font-weight:bold;"><?php echo e(strtoupper($booking->payment_status)); ?></span>
                                </p>
                            </td>
                        </tr>
                    </table>
                                    ...
                                    <table style="width:100%; border-collapse:collapse;">
                                        <tr>
                                            <td style="width:280px; vertical-align:top; text-align:center; padding-right:15px;">
                                                <img src="<?php echo e($mainImage); ?>" style="width:280px; height:auto; max-height:180px; object-fit:cover; border-radius:5px; border:1px solid #ddd;" alt="Vehicle">
                                                <div style="margin-top:8px;">
                                                    <?php $__currentLoopData = $thumbnails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <img src="<?php echo e($thumb ? asset('storage/' . ltrim($thumb, '/')) : 'https://via.placeholder.com/60x45?text=No+Image'); ?>" style="width:60px;height:45px;object-fit:cover;margin:0 3px;border-radius:3px;border:1px solid #ddd;">
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            </td>
                                            <td style="vertical-align:top; text-align:left; padding-left:15px;">
                                                <p style="margin:0 0 10px 0; font-size:18px; color:#333; font-weight:bold;"><?php echo e($booking->vehicle->name); ?> - <?php echo e($booking->vehicle->model); ?></p>
                                                <p style="margin:8px 0; color:#666; font-size:14px;"><strong>Start Date/Time:</strong> <?php echo e($booking->start_datetime?->format('Y-m-d H:i') ?? 'N/A'); ?></p>
                                                <p style="margin:8px 0; color:#666; font-size:14px;"><strong>End Date/Time:</strong> <?php echo e($booking->end_datetime?->format('Y-m-d H:i') ?? 'N/A'); ?></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    <table style="width:100%; border-collapse:collapse; margin-bottom:20px; page-break-before: always;">
                        ...
                        <tbody>
                            <tr style="border-bottom:1px solid #ddd;">
                                ...
                                <td style="padding:12px; text-align:right; font-size:14px; color:#666;"><?php echo e($booking->currency); ?> <?php echo e(number_format($booking->price,2)); ?></td>
                            </tr>
                            <tr style="border-bottom:1px solid #ddd;">
                                <td style="padding:12px; font-size:14px; color:#666;">Additional Charges</td>
                                <td style="padding:12px; text-align:right; font-size:14px; color:#666;"><?php echo e($booking->currency); ?> <?php echo e(number_format($booking->additional_price,2)); ?></td>
                            </tr>
                            <tr style="border-bottom:1px solid #ddd;">
                                <td style="padding:12px; font-size:14px; color:#666;">Discount</td>
                                <td style="padding:12px; text-align:right; font-size:14px; color:#28a745;">- <?php echo e($booking->currency); ?> <?php echo e(number_format($booking->discount,2)); ?></td>
                            </tr>
                            <tr style="background:#f0f0f0;">
                                <td style="padding:15px 12px; font-size:16px; color:#333; font-weight:bold;">TOTAL AMOUNT</td>
                                <td style="padding:15px 12px; text-align:right; font-size:18px; color:#333; font-weight:bold;"><?php echo e($booking->currency); ?> <?php echo e(number_format($booking->total_price,2)); ?></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <?php if($booking->notes): ?>
                        <div style="margin-bottom:20px; padding:15px; background:#fffbea; border-left:4px solid #ffc107;">
                            <p style="margin:0; font-size:14px; color:#666;"><strong>Note:</strong> <?php echo e($booking->notes); ?></p>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Vehicle Booking Details'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Vacay Guider\vacay-admin\resources\views/bookings/rent/show.blade.php ENDPATH**/ ?>