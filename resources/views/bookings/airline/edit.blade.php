...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Edit Airline Booking</h5>
        </div>
...
@endif
            ...
            <form action="{{ route('admin.airline-bookings.update', $airline_booking->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                        ...
                        <select name="customer_id" class="form-select" required>
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{ $customer->id }}"
                                    {{ $airline_booking->customer_id == $customer->id ? 'selected' : '' }}>
                        ...
                        <select name="agent_id" class="form-select" required>
                            ...
                            @foreach ($agents as $agent)
                                <option value="{{ $agent->id }}"
                                    {{ $airline_booking->agent == $agent->id ? 'selected' : '' }}>
                        ...
                        <select name="from_country" class="form-select" required>
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ $country['en'] }}"
                                    {{ $airline_booking->from_country == $country['en'] ? 'selected' : '' }}>
                                    {{ $country['en'] }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="to_country" class="form-select" required>
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ $country['en'] }}"
                                    {{ $airline_booking->to_country == $country['en'] ? 'selected' : '' }}>
                                    {{ $country['en'] }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input type="datetime-local" name="departure_datetime" class="form-control"
                            value="{{ $airline_booking->departure_datetime ? date('Y-m-d\TH:i', strtotime($airline_booking->departure_datetime)) : '' }}"
                            required>
                    </div>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input type="datetime-local" name="arrival_datetime" class="form-control"
                            value="{{ $airline_booking->arrival_datetime ? date('Y-m-d\TH:i', strtotime($airline_booking->arrival_datetime)) : '' }}"
                            required>
                    </div>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input type="text" name="airline" class="form-control" value="{{ $airline_booking->airline }}">
                    </div>
                        ...
                        <select name="status" class="form-select">
                            @foreach (['Quotation', 'Accepted', 'Invoiced', 'Partially Paid', 'Paid', 'Cancelled'] as $statusOption)
                                <option value="{{ $statusOption }}"
                                    {{ $airline_booking->status == $statusOption ? 'selected' : '' }}>
                                    {{ $statusOption }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="payment_status" class="form-select">
                            @foreach (['unpaid', 'partial', 'paid'] as $pStatus)
                                <option value="{{ $pStatus }}"
                                    {{ $airline_booking->payment_status == $pStatus ? 'selected' : '' }}>
                                    {{ ucfirst($pStatus) }}
                                </option>
                            @endforeach
                        </select>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="currency" id="currency" class="form-select">
                                            @foreach (['LKR', 'USD', 'EUR'] as $cur)
                                                <option value="{{ $cur }}"
                                                    {{ $airline_booking->currency == $cur ? 'selected' : '' }}>
                                                    {{ $cur }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="base_price" id="base_price" class="form-control"
                                            value="{{ $airline_booking->base_price }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="additional_price" id="additional_price"
                                            class="form-control" value="{{ $airline_booking->additional_price }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="discount" id="discount" class="form-control"
                                            value="{{ $airline_booking->discount }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="total_amount" id="total_amount" class="form-control"
                                            value="{{ $airline_booking->total_amount }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="advanced_paid" id="advanced_paid"
                                            class="form-control" value="{{ $airline_booking->advanced_paid }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="balance" id="balance" class="form-control"
                                            value="{{ $airline_booking->balance }}" readonly>
                                    </div>
                                </div>
...
@section('scripts')
    <script>
        ...
        function previewBooking() {
            ...
            const html = `<div style="max-width:800px;margin:0 auto;font-family:'Helvetica Neue',Arial,sans-serif;color:#333;background:#fff;padding:25px;">
