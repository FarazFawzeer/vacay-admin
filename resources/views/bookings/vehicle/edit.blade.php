    ...
    <div class="card">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="vehicleBookingForm" action="{{ route('admin.vehicle-bookings.update', $booking->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="pickup_location" id="pickup_location" class="form-control"
                                placeholder="e.g., Colombo Airport" value="{{ $booking->pickup_location }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Pickup Date & Time</label>
                            <input type="datetime-local" name="pickup_datetime" id="pickup_datetime" class="form-control"
                                value="{{ $booking->pickup_datetime ? date('Y-m-d\TH:i', strtotime($booking->pickup_datetime)) : '' }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Drop-off Location</label>
                            <input type="text" name="dropoff_location" id="dropoff_location" class="form-control"
                                placeholder="e.g., Kandy City Centre" value="{{ $booking->dropoff_location }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="datetime-local" name="dropoff_datetime" id="dropoff_datetime" class="form-control"
                                value="{{ $booking->dropoff_datetime ? date('Y-m-d\TH:i', strtotime($booking->dropoff_datetime)) : '' }}">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="mileage" id="mileageSelect" class="form-select" required>
                                    <option value="unlimited" {{ $booking->mileage == 'unlimited' ? 'selected' : '' }}>
                                        Unlimited</option>
                                    <option value="limited" {{ $booking->mileage == 'limited' ? 'selected' : '' }}>Limited
                                    </option>
                                </select>
                            </div>
        ...
        <tr>
            ...
            <td style="text-align:right;">
                ...
                <table style="margin-left:auto;margin-top:10px;font-size:13px;">
                    <tr><td style="color:#888;padding:2px 10px;"> Reference</td><td>${invoiceNo}</td></tr>
