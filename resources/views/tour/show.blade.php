                                    ...
                                    <div class="vehicle-card">
                                        ...
                                        <div class="vehicle-info">
                                            <div class="vehicle-info-header">
                                                <h4 class="vehicle-name">{{ $vehicle->name ?? 'Vehicle Name' }}</h4>
                                                <p class="vehicle-subtitle">{{ $vehicle->make ?? '' }}
                                                    {{ $vehicle->model ?? '' }}</p>
                                            </div>
                                            ...
                                            <div class="vehicle-info-list">
                                                <div class="vehicle-info-item">
                                                    <strong>Make</strong>
                                                    <span>{{ $vehicle->make ?? 'Not specified' }}</span>
                                                </div>

                                                <div class="vehicle-info-item">
                                                    <strong>Model</strong>
                                                    <span>{{ $vehicle->model ?? 'Not specified' }}</span>
                                                </div>

                                                <div class="vehicle-info-item">
                                                    <strong>Seats Available</strong>
                                                    <span>{{ $vehicle->seats ?? 'Not specified' }}</span>
                                                </div>

                                                <div class="vehicle-info-item">
                                                    <strong>Max Capacity</strong>
                                                    <span>{{ $vehicle->max_seating_capacity ?? 'Not specified' }}
                                                        passengers</span>
                                                </div>

                                                <div class="vehicle-info-item">
                                                    <strong>Condition</strong>
                                                    <span>{{ ucfirst($vehicle->condition ?? 'Not specified') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
