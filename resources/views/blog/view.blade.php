@extends('layouts.vertical', ['subtitle' => 'Blog Posts'])

@section('content')
    @include('layouts.partials.page-title', ['title' => 'Blog Posts', 'subtitle' => 'View'])
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchFilteredData(url = null) {
                ...
                let baseUrl = "{{ route('admin.blogs.index') }}";
            ...
            function attachStatusToggleEvents() {
                document.querySelectorAll('.toggle-status').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        fetch("{{ url('admin/blogs/status') }}/" + blogId, {
                                method: 'POST',
                                headers: {
                                    'X-CSRF-TOKEN': "{{ csrf_token() }}",
