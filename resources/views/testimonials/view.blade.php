...
@section('content')
    @include('layouts.partials.page-title', ['title' => 'Testimonials', 'subtitle' => 'View'])
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchFilteredData(url = null) {
                ...
                let baseUrl = "{{ route('admin.testimonials.index') }}";
                    ...
                    button.addEventListener('click', function() {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                fetch("{{ url('admin/testimonials') }}/" + id, {
                                    method: 'DELETE',
                                    headers: {
            ...
            function attachStatusToggleEvents() {
                document.querySelectorAll('.toggle-status').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        fetch("{{ url('admin/testimonials/toggle-status') }}/" + id, {
                            method: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': "{{ csrf_token() }}",
