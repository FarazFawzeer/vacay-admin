                        ...
                        @forelse($bookings as $booking)
                            <tr id="booking-{{ $booking->id }}">
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button
                                            class="btn btn-sm status-dropdown-btn dropdown-toggle
                                            ...
                                            @foreach (['pending', 'confirmed', 'completed', 'cancelled'] as $statusOption)
                                                <li>
                                                    <a class="dropdown-item change-status" href="#"
                                                        data-id="{{ $booking->id }}" data-status="{{ $statusOption }}">
                                ...
                                <td class="text-center">
                                    <button type="button" class="icon-btn text-danger delete-booking"
                                        data-id="{{ $booking->id }}" title="Delete Booking">
                            ...
                            fetch(`/admin/enquiry/${bookingId}`, {
                                ...
                                .then(data => {
                                    if (data.success) {
                                        ...
                                        // Remove row
                                        document.getElementById(`booking-${bookingId}`)
                                            .remove();
