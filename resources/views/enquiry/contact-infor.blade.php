@extends('layouts.vertical', ['subtitle' => 'Contact Inquiries'])
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive" id="contactTable">
                @include('enquiry.contact-infor-table', ['contacts' => $contacts])
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('admin.enquiry.contactUs') }}?name=${search}`, {
                        headers: {
            ...
            document.addEventListener('change', function(e) {
                if (e.target.classList.contains('changeStatus')) {
                    ...
                    fetch("{{ route('admin.enquiry.contactUs.updateStatus') }}", {
                            method: "POST",
                            headers: {
